        ...
        <VStack w="full" p={10} spacing={10} alignItems="flex-start" bg="gray.100">
            ...
            <SimpleGrid column={2} columnGap={3} rowGap={10} w="full">
                ...
                <GridItem colSpan={colSpan}>
                    <HStack justifyContent="space-between">
                        <HStack>
                            <Button onClick={() => router.push('/')} w={114} h={30} rounded="lg" _selected={{ color: 'white', bg: 'green.300' }} color="white" bg="green.300" >Огласи</Button>

                            <Button onClick={() => router.push('/profiles')} w={114} h={30} rounded="lg" _selected={{ color: 'white', bg: 'pink' }} colorScheme="green">Профили</Button>

                        </HStack>
                        <Button bg="white" colorScheme="whiteAlpha" color="black" leftIcon={<Icon as={FiFilter} />}>Filter</Button>
                    </HStack>
                </GridItem>
            </SimpleGrid>
                ...
                <GridItem colSpan={colSpan}>
                    ...
                    <VStack>
                        ...
                        <VStack rounded="lg" bg="white" w={333} alignItems="start" pl={2} pt={5} pb={11} mb={-10} pr={10}>
                            ...
                            <HStack alignItems="start" style={{ marginTop: 0 }}>
                                <AspectRatio ratio={1} w={24}>
                                    <Image src='images/profile-pic.jpg' alt="photo"></Image>
                                </AspectRatio>
                        ...
                        <VStack justifyContent="end" pl={293}>
                            <IconButton colorScheme="green" size="md" fontSize={30} aria-label='See more' icon={<FiArrowRight />} />
                        </VStack>
            ...
            <SimpleGrid column={2} columnGap={3} rowGap={10} w="full">
                <GridItem colSpan={colSpan}>
                    <Container>
                        <VStack pl={0}>
                            <IconButton colorScheme="green" size="md" fontSize={40} aria-label='See more' icon={<ArrowDownIcon />} />
