                ...
                <GridItem colSpan={colSpan} w="full" h="full" pl={5} pt={5} pr={5} mb={-5} alignItems="flex-start" bg="#FFFFFF" borderRadius={10}>
                    <VStack >
                        <VStack alignItems="flex-start">
                            ...
                            <Text fontSize={14}>Mattis enim, vitae cursus pellentesque sed. Orci ultrices quis a lobortis. Vitae posuere pretium dolor egestas viverra nisi, fusce gravida dui. Diam nibh velit id pharetra, nisl neque sapien, nisl. Blandit sed sagittis adipiscing et in. Tempor, vitae a orci aliquet tellus, nisl, non. Viverra orci libero, quam donec nisi, hendrerit.</Text>


                            <HStack justifyContent="space-between" pt={5}>
                                <Heading size="xs">Цена:</Heading>
                                <Text fontSize="sm">По договор</Text>
                                <Heading size="xs" pl={5}>Достапност:</Heading>
                                <Text fontSize="sm">09:00ч до 21:00ч</Text>
                                <Heading size="xs" pl={5}>Локација:</Heading>
...
export default DetailsPomosnik;